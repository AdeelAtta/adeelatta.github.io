...
export const widgetDefinitions: WidgetDefinition[] = [
  ...
  { id: "projects", title: "Projects", icon: FolderKanban, component: ProjectsWidget, defaultSize: { w: 12, h: 16 }, minSize: { w: 6, h: 4 } },
...
export function getDefaultLayout() {
  return [
    ...
    { i: "projects",     x: 12, y: 26, w: 12, h: 18, minW: 6, minH: 4 },
  ]
}
...
function mdLayout() {
  return [
    ...
    { i: "projects",     x: 6,  y: 34, w: 6,  h: 16, minW: 6, minH: 4 },
  ]
}
...
function smLayout() {
  return [
    ...
    { i: "projects",     x: 0, y: 47, w: 6, h: 14, minW: 6, minH: 4 },
  ]
}
